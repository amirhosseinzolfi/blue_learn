...
window.Icons = {
    ...
    ChevronLeft: (props) => <IconBase {...props}><polyline points="15 18 9 12 15 6"></polyline></IconBase>,
    ...
    Pause: (props) => <IconBase {...props}><rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect></IconBase>,
    Layout: (props) => <IconBase {...props}><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></IconBase>,
    Trophy: (props) => <IconBase {...props}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"></path><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"></path><path d="M4 22h16"></path><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"></path><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"></path><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"></path></IconBase>,
    Loader2: (props) => <IconBase {...props} className={"animate-spin " + (props.className || '')}><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line></IconBase>,
    ...
    Send: (props) => <IconBase {...props}><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></IconBase>,
    ...
    Maximize: (props) => <IconBase {...props}><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"></path></IconBase>,
    Minimize: (props) => <IconBase {...props}><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"></path></IconBase>,
    Clock: (props) => <IconBase {...props}><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></IconBase>,
    Sparkles: (props) => <IconBase {...props}><path d="M9.937 15.5L8 10.5L3 8.563L8 6.625L9.937 1.5L11.875 6.625L16.875 8.563L11.875 10.5L9.937 15.5Z" fill="currentColor" stroke="none" /><path d="M17.437 20.5L16.5 18L14 17.063L16.5 16.125L17.437 13.5L18.375 16.125L20.875 17.063L18.375 18L17.437 20.5Z" fill="currentColor" stroke="none" /><path d="M5.437 22.5L4.5 20L2 19.063L4.5 18.125L5.437 15.5L6.375 18.125L8.875 19.063L6.375 20L5.437 22.5Z" fill="currentColor" stroke="none" /></IconBase>,
    BarChart: (props) => <IconBase {...props}><line x1="12" y1="20" x2="12" y2="10"></line><line x1="18" y1="20" x2="18" y2="4"></line><line x1="6" y1="20" x2="6" y2="16"></line></IconBase>,
    ...
    Image: (props) => <IconBase {...props}><rect width="18" height="18" x="3" y="3" rx="2" ry="2"></rect><circle cx="9" cy="9" r="2"></circle><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"></path></IconBase>,
    ...
    Target: (props) => <IconBase {...props}><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></IconBase>,
    Flame: (props) => <IconBase {...props}><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3 0-1.11.45-2.22 1.3-3.04.14.14.35.3.5.5a2.5 2.5 0 0 1 1 2c0 .7-.14 1.41-.3 2.1l-.3 1.2c-.1.4-.1.8 0 1.2.2.4.5.7.9.9.5.2 1 .3 1.5.2a3 3 0 0 0 2-2c0-.7-.13-1.41-.3-2.1l-.3-1.2c-.4-1.6 0-3.2 1.2-4.4 1.2 1.2 1.6 2.8 1.2 4.4l-.3 1.2c-.17.69-.3 1.4-.3 2.1a5 5 0 0 0 10 0c0-1.38-.5-2-1-3 0-1.11.45-2.22 1.3-3.04.14.14.35.3.5.5a5 5 0 0 1 2 4 8 8 0 0 1-16 0z"></path></IconBase>,
    ...
    Users: (props) => <IconBase {...props}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></IconBase>,
    Search: (props) => <IconBase {...props}><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></IconBase>,
    Share: (props) => <IconBase {...props}><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path><polyline points="16 6 12 2 8 6"></polyline><line x1="12" y1="2" x2="12" y2="15"></line></IconBase>,
};
