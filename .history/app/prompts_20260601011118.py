...
IMPORTANT: If the user has pre-selected any of the preferences above, DO NOT ask them about these preferences. Acknowledge them if appropriate and immediately skip to the remaining steps. Use these selected values to customize the course.
