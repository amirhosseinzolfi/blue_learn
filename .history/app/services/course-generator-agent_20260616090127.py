...
def summarize_history(state: CoachState) -> CoachState:
    ...
    try:
        ...
        # Keep all messages if summary fails to avoid losing memory.
        result = {
    ...
    try:
        ...
        result = {
            "assistant_message": (
                ...
                "the result you want the learner to achieve and who this course is for."
            ),
            "ready_to_generate": False,
            "missing_information": ["desired outcome", "target learner"],
        }
...
def generate_course_outline(state: CoachState) -> CoachState:
    ...
    try:
        ...
        # Do not set course_outline here; otherwise the app will show false DONE.
        result = {
            "assistant_message": (
